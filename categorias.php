    ...
    <div class="row mb-4">
        <div class="col-12 col-md-8">
            <form class="d-flex" method="get" action="categorias.php">
                <input class="form-control me-2" type="text" name="search" placeholder="Buscar categorías">
                <input class="btn btn-secondary" type="submit" value="Buscar">
            </form>
        </div>
        <div class="col-12 col-md-4 mt-2 mt-md-0 text-md-end">
            <button type="button" data-bs-toggle="modal" data-bs-target="#addCategoryModal" class="btn btn-success w-100 w-md-auto">Nueva Categoría</button>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editCategoryModal" data-id="<?= $categoria['id'] ?>" data-nombre="<?= $categoria['nombre'] ?>" data-descripcion="<?= $categoria['descripcion'] ?>">Editar</button>
                            <button class="btn btn-danger btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#deleteCategoryModal" data-id="<?= $categoria['id'] ?>">Eliminar</button>
                            <a class="btn btn-warning ms-2" href="productos.php?category=<?= $categoria['id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addCategoryForm" action="storeCategory.php" method="post">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="editCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editCategoryForm" action="updateCategory.php" method="post">
