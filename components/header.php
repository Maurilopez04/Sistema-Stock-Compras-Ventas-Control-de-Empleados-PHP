    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Bytech Paraguay</h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="marcas.php">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="registro_general.php">
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="registro_compras.php">
                <svg class="bi"><use xlink:href="#file-earmark-text"></use></svg>
                Registro Compras
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="registro_ventas.php">
                <svg class="bi"><use xlink:href="#file-earmark-text"></use></svg>
                Registro Ventas
              </a>
            </li>
...
-->
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="createUsuario.php">
